    ...
    <div class="container"><a name="BlockContactUs"></a>
      <div class="row">
        ...
        <div class="col-xs-11 col-sm-6 col-md-5 col-lg-4">
            ...
            <p>Лицам, не достигшим совершеннолетия необходимо разрешение родителей или опекунов.<br/><a href="https://wiki.viruviking.club/public:4parents_faq" target="_blank">Родителям: вопросы и ответы</a></p>
