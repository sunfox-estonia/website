...
if($_POST['contact_mail'] && $_POST['contact_message']){
  ...
  if ($_POST["recaptcha_response_field"]) {
    $response=json_decode(file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LeN-CEUAAAAAJEKcUXmRWmVEDL6bQvJGmT-9xYa&response=".$_POST['recaptcha_response_field']."&remoteip=".$_SERVER['REMOTE_ADDR']), true);
